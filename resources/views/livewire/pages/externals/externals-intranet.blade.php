            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
                <div id="Columna1" class="lg:col-span-2">
                    ...
                    <p class="mt-2 text-sm sm:text-base text-gray-500">
                        Acceso a herramientas y sistemas externos del Hospital Nacional
                    </p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col justify-between hover:shadow-md transition">
                    <div>
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-10 h-10 rounded-lg bg-green-hn/10 flex items-center justify-center overflow-hidden">
                        ...
                        <p class="text-sm sm:text-base text-gray-500">
                            {{ $tool->descripcion_corta ?? 'Herramienta externa del Hospital Nacional' }}
                        </p>
                    </div>
                    <div class="mt-6">
                        @if($tool->browser == '1')
                        ...
                        @else
                            <a href="{{ $tool->app_url }}" target="_blank"
